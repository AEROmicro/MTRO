...
const CITIES = [
  ...
  { id: "san-francisco", provider: "gtfsrt-protobuf", bbox: [37.93, -122.56, 37.70, -122.30], endpoints: ["http://api.bart.gov/gtfsrt/vehiclepositions.aspx", "https://api.bart.gov/gtfsrt/vehicles.pb"] },
  { id: "oakland", provider: "gtfsrt-protobuf", bbox: [37.90, -122.38, 37.65, -122.10], endpoints: ["http://api.bart.gov/gtfsrt/vehiclepositions.aspx", "https://api.bart.gov/gtfsrt/vehicles.pb"] },
